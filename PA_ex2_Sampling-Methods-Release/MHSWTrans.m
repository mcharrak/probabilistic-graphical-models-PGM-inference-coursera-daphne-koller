...
if variant == 1
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    uniform_prob = 1/d;
    LogR = log(repmat(uniform_prob,1,d));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
log_prob_pi_Q_x_prime_to_x = LogProbOfJointAssignment(F,A_prop); % numerator
log_prob_pi_Q_x_to_x_prime = LogProbOfJointAssignment(F,A); % denumerator

logR_new = LogR(new_value);
logR_old = LogR(old_value);
log_RY_ratio = (logR_old + log_prob_pi_Q_x_prime_to_x) - ...
               (logR_new + log_prob_pi_Q_x_to_x_prime);

log_prob_ratio = log_QY_ratio + log_RY_ratio;
prob_ratio = exp(log_prob_ratio);
