...
for i = 1:numel(F)
  ...
  %vals = [(F(i).val(:)(selIdx))'];
  % from FORUM we replace line 280 with the following
  % source https://www.coursera.org/learn/probabilistic-graphical-models-2-inference/discussions/weeks/2/threads/3JabcL5EEeaYcRJ-aKpq1A
